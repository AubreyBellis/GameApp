...
//fourth column of buttons from top to bottom 
$("#14").on('click',function(){
    var x = prompt(quest16)
    if (x === ans16) {
        alert('You got it!')
    } else {
        alert('Sorry, that is wrong!');
...
//Fifth row of columns from top to bottom 
$("#15").on('click',function(){
    var x = prompt(quest21)
    if (x === ans21) {
        alert('You got it!')
    } else {
        alert('Sorry, that is wrong!');
